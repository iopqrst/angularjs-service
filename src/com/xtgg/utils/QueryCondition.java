...
public class QueryCondition {
	 ...
	 * 管理链
	 */
	private String createUserChain;
	...
	private String subPass; // 判断是客户是医生邀请还是客户邀请
	/**
	 * 邀请码
	 */
	private String passivityinvite;
	...
	public String getCreateUserChain() {
		return createUserChain;
	}

	public void setCreateUserChain(String createUserChain) {
		this.createUserChain = createUserChain;
	}
	...
	public String toString() {
		return "QueryCondition [areaName=" + areaName + ", beginTime="
				...
				+ productName + ", userId=" + userId + ", createUserChain="
				+ createUserChain + "]";
	}
